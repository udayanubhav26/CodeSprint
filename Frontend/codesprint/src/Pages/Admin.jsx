        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {adminOptions.map((option) => {
            ...
            return (
              <div
                key={option.id}
                className="bg-black/40 border border-gray-800 hover:border-purple-500 rounded-xl p-4  card shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer"
              >
